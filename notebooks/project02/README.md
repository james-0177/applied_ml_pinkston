# Project 02:  Working with the Titantic Dataset

Project 02 uses the Titantic dataset to perform exploratory data analysis and machine learning preparation. I'll import, inspect, explore, and clean the data; and then I'll split the data for training and testing.
